...
def _get_request_tenant_id(request) -> int | None:
    ...
    tenant_param = request.query_params.get("tenant_id") if hasattr(request, "query_params") else None
...
class SSIDViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        site_id = self.request.query_params.get("site_id") if hasattr(self.request, "query_params") else None
